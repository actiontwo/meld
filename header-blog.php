...
<div id="siteWrapper" class="clearfix">
  ...
  <div class="sqs-cart-dropzone"></div>
    ...
    <header class="header_new" style="background:#7F7F7F;">
...
<a href="<?php echo home_url(); ?>"><img src="<?php echo ot_get_option( 'theme_logo_2' ); ?>" /></a>

<?php } else { ?>

 <a href="<?php echo home_url(); ?>"><img src="<?php echo ot_get_option( 'theme_logo' ); ?>" /></a>
<?php } ?>
                    	...
                    	<div class="row">
                        	...
                        	<div class="col-md-9">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://www.mystreetscape.com" target="_blank"><i class="fa fa-user"></i> CLIENT LOGIN</a></li>

                                    <li><a href="http://melduniversity.com/contact-1/" target="_blank"><i class="fa fa-phone"></i> CONTACT US</a></li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="top_action">
                                    ...
                                    <a href="http://melduniversity.com/blog/"><?php echo ot_get_option( 'header_change_name' ); ?></a>
